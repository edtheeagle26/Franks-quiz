  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-6 text-center">
      <div className="max-w-2xl mx-auto space-y-8">
        <h1
          className="text-4xl md:text-6xl font-bold tracking-tight text-foreground uppercase"
        ...
        <div className="space-y-3 text-muted-foreground text-lg md:text-xl">
          ...
          <p>Tijd voor een debriefing. Herken jij alle 20 jachtvliegtuigen uit het archief?</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
          <Link href="/quiz">
            <Button
              size="lg"
              className="w-full sm:w-auto text-xl px-12 py-8 rounded-none border-2 border-primary bg-primary/20 hover:bg-primary text-primary hover:text-primary-foreground transition-all uppercase tracking-widest font-bold"
          ...
          <Link href="/scoreboard">
            <Button
              size="lg"
              variant="outline"
              className="w-full sm:w-auto text-xl px-12 py-8 rounded-none border-2 border-border bg-transparent hover:bg-muted text-muted-foreground hover:text-foreground transition-all uppercase tracking-widest font-bold"
